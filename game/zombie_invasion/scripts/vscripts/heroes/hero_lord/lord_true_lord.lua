...
function lord_true_lord:GetIntrinsicModifierName()
	return "modifier_lord_true_lord"
end

function lord_true_lord:OnSpellStart()
...
function modifier_lord_true_lord:OnCreated()
...
function modifier_lord_true_lord:OnRefresh()
    self:OnCreated()
end 

function modifier_lord_true_lord:GetModifierPhysicalArmorBonus() 
    return self.bonus_armor
end

function modifier_lord_true_lord:GetModifierPreAttack_BonusDamage() 
    return self.bonus_damage
end

function modifier_lord_true_lord:GetModifierIncomingDamage_Percentage()
    return -self.bonus_resist
end

function modifier_lord_true_lord:OnAttack(keys)
    local parent = self:GetParent()
...
function modifier_lord_true_lord:OnTakeDamage( keys )
