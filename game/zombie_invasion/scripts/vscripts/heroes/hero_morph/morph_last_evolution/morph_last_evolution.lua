LinkLuaModifier("modifier_morph_last_evolution", "heroes/hero_morph/morph_last_evolution/morph_last_evolution.lua", LUA_MODIFIER_MOTION_NONE)

morph_last_evolution = class({
    GetIntrinsicModifierName = function() return "modifier_morph_last_evolution" end,
})

modifier_morph_last_evolution = class({
    IsPurgable      = function() return false end,
    DestroyOnExpire = function() return false end,
})

function modifier_morph_last_evolution:DeclareFunctions()
    return {
...
function modifier_morph_last_evolution:GetModifierManaBonus()
    return self.ManaModifier or self:GetSharedKey("ManaModifier") or 0
end

function modifier_morph_last_evolution:OnTooltip()
...
function modifier_morph_last_evolution:GetModifierPhysicalArmorBonus()
    return self.armorReduction
end
if IsServer() then
    modifier_morph_last_evolution.think_interval = 1/30
    function modifier_morph_last_evolution:OnCreated()
    ...
    function modifier_morph_last_evolution:OnDestroy()
        local parent = self:GetParent()
    ...
    function modifier_morph_last_evolution:OnIntervalThink()
        local parent = self:GetParent()
        local ability = self:GetAbility()
