LinkLuaModifier( "modifier_ability_tidehunter_anchor_smash_passive", "heroes/hero_tide/anchor_smash" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_tidehunter_anchor_smash", "heroes/hero_tide/anchor_smash" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_tidehunter_anchor_smash_reduction", "heroes/hero_tide/anchor_smash" ,LUA_MODIFIER_MOTION_NONE )
...
function ability_tidehunter_anchor_smash:GetIntrinsicModifierName()
    return "modifier_ability_tidehunter_anchor_smash_passive"
end

modifier_ability_tidehunter_anchor_smash_passive = class({})

function modifier_ability_tidehunter_anchor_smash_passive:OnCreated()
...
function modifier_ability_tidehunter_anchor_smash_passive:OnAttackLanded(keys)
...
function modifier_ability_tidehunter_anchor_smash:Smash()
