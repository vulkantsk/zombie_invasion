LinkLuaModifier( "modifier_ability_viper_corrosive_skin", "abilities/zombie/Boss/viper_corrosive_skin", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_viper_corrosive_skin_slow", "abilities/zombie/Boss/viper_corrosive_skin", LUA_MODIFIER_MOTION_NONE )
