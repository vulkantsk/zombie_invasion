...
LinkLuaModifier( "modifier_ability_malefice", "heroes/hero_enigma/malefice/malefice", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_malefice_stun", "heroes/hero_enigma/malefice/malefice", LUA_MODIFIER_MOTION_NONE )
