LinkLuaModifier( "modifier_wisp_ambient", "heroes/hero_templar/the_lost_of_assassin/the_lost_of_assassin", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_bedlam", "heroes/hero_templar/the_lost_of_assassin/the_lost_of_assassin", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_bedlam_attack", "heroes/hero_templar/the_lost_of_assassin/the_lost_of_assassin", LUA_MODIFIER_MOTION_NONE )
...
function ability_bedlam:GetModifierProcAttack_Feedback()
	-- unit identifier
...
function modifier_ability_bedlam_attack:OnCreated( kv )
	...
	self.attack_targets = self:GetAbility():GetSpecialValueFor( "attack_targets" )
