...
modifier_torture_pipe_buff.whitelist = {
	...
	juggernaut_blade_fury				= {blade_fury_damage_per_tick = true},
	...
	huskar_burning_spear				= {burn_damage = true},									--special_bonus_unique_huskar_2			= {value = true},
	...
	pugna_life_drain_lua				= {health_drain = true, scepter_health_drain = true},
	...
	queenofpain_shadow_strike_lua		= {duration_damage = true},
	queenofpain_sonic_wave				= {damage = true},
	...
	ancient_apparition_ice_vortex		= {shard_dps = true},
	...
	warlock_upheaval_lua				= {damage_per_second = true, max_damage = true},
	phoenix_supernova_lua				= {damage_per_sec = true},
	oracle_rain_of_destiny 				= {damage = true},
	venomancer_latent_poison 			= {duration_damage = true},
	bane_enfeeble						= {enfeeble_tick_damage = true},
	ember_spirit_fire_remnant			= {shard_damage_per_second = true},
	furion_sprout						= {sprout_damage = true},
	night_stalker_crippling_fear		= {dps = true},
	item_witch_blade					= {int_damage_multiplier = true},
	item_devastator 					= {int_damage_multiplier = true},
