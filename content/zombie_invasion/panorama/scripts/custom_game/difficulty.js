...
( () => {
	...
	for ( let diff of ["normal", "medium", "hard"] ) {
		...
		button.SetPanelEvent( "onmouseover", () => {
			...
			$.DispatchEvent( "UIShowTextTooltip", button, $.Localize( "#difficulty_description_" + diff ) )
		} )
	...
	GameEvents.Subscribe( "update_difficulty_selections", update_difficulty_selections )
} )()