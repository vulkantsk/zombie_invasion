...
LinkLuaModifier( "modifier_lifestealer_passive", "modifiers/monsters/modifier_lifestealer_passive", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lifestealer_damage_counter", "modifiers/monsters/modifier_lifestealer_damage_counter", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lifestealer_enraged", "modifiers/monsters/modifier_lifestealer_enraged", LUA_MODIFIER_MOTION_NONE )
