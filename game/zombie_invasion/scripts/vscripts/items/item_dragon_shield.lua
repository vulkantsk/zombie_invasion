LinkLuaModifier("modifier_item_dragon_shield_stats", "items/item_dragon_shield", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier('modifier_abaddon_aphotic_shield_lua', 'items/item_dragon_shield', LUA_MODIFIER_MOTION_NONE)

item_dragon_shield = class({
    GetIntrinsicModifierName = function() return "modifier_item_dragon_shield_stats" end
})
...
modifier_item_dragon_shield_stats = class({
...
function modifier_item_dragon_shield_stats:GetTexture()
	return "item_dragon_shield"
end

function modifier_item_dragon_shield_stats:OnCreated()
	self.bonus_resistance = self:GetAbility():GetSpecialValueFor("bonus_resistance")
	self.bonus_armor = self:GetAbility():GetSpecialValueFor("bonus_armor")
end

function modifier_item_dragon_shield_stats:OnRefresh()
    self:OnCreated()

end

function modifier_item_dragon_shield_stats:GetModifierMagicalResistanceBonus()
	return self.bonus_resistance 
end

function modifier_item_dragon_shield_stats:GetModifierPhysicalArmorBonus()
