...
--	thisEntity:AddNewModifier( thisEntity, nil, "modifier_fow_vision", nil )
	...
	PointAbility = thisEntity:FindAbilityByName( "custom_thundercall" )
	NoTargetAbility = thisEntity:FindAbilityByName( "npc_leshrac_split_earth" )
	TargetAbility = thisEntity:FindAbilityByName( "custom_leshrac_diabolic_edict" )
