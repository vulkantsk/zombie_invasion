item_spirit_pochti_vessel = class({})
...
function item_spirit_pochti_vessel:OnSpellStart()
...
function item_spirit_pochti_vessel:CastFilterResultTarget(target)
	local caster = self:GetCaster()

	-- Should not be cast on magic immune enemies
