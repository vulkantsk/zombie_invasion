...
grim_big_health = class({})

function grim_big_health:Precache(context)
...
function grim_big_health:OnSpellStart()
...
function grim_big_health:PlayEffects2( origin, target )
