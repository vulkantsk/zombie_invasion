ability_wisp_teleport = {}

LinkLuaModifier( "modifier_ability_wisp_teleport", "heroes/hero_wisp/ability_wisp_teleport", LUA_MODIFIER_MOTION_NONE )

function ability_wisp_teleport:OnSpellStart()
	...
	local modifier = target:AddNewModifier(
		caster,
		self,
		"modifier_ability_wisp_teleport",
		{ duration = duration }
	)

	local ability = caster:FindAbilityByName( "ability_wisp_teleport_cancel" )
	if not ability then
		ability = caster:AddAbility( "ability_wisp_teleport_cancel" )
...
ability_wisp_teleport_cancel = {}

function ability_wisp_teleport_cancel:OnSpellStart()
...
function modifier_ability_wisp_teleport:IsDebuff()
	return false
end

function modifier_ability_wisp_teleport:IsPurgable()
	return false
end

function modifier_ability_wisp_teleport:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

function modifier_ability_wisp_teleport:OnCreated( kv )
...
function modifier_ability_wisp_teleport:OnRemoved()
	if not IsServer() then return end
	...
	local ability = self:GetCaster():FindAbilityByName( "ability_wisp_teleport_cancel" )
...
function modifier_ability_wisp_teleport:DeclareFunctions()
	local funcs = {
...
function modifier_ability_wisp_teleport:OnDeath( params )
	if not IsServer() then return end
...
function modifier_ability_wisp_teleport:CheckState()
	local state = {
...
function modifier_ability_wisp_teleport:Cancel()
	self.success = false
...
function modifier_ability_wisp_teleport:PlayEffects1()
...
function modifier_ability_wisp_teleport:PlayEffects2()
...
function modifier_ability_wisp_teleport:PlayEffects3()
...
function modifier_ability_wisp_teleport:PlayEffects4()
	local caster = self:GetCaster()
	local parent = self:GetParent()
