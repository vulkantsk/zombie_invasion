LinkLuaModifier( "modifier_ability_last_word_silence", "heroes/hero_silencer/last_word", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_last_word", "heroes/hero_silencer/last_word", LUA_MODIFIER_MOTION_NONE )
