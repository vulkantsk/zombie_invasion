...
function RespawnWoobleydog2(keys)	
    ...
    print(chance_spawn)
     if name == "npc_classic_woobleydog2" then
         if chance_spawn < 1 then
			 Timers:CreateTimer(respawn_time,function()	
		         local unit = CreateUnitByName("npc_classic_woobleydog2", position , true, nil, nil, team)
     ...
     elseif name == "npc_classic_woobleydog" then 
     	 	 Timers:CreateTimer(respawn_time,function()	
		         local unit = CreateUnitByName("npc_classic_woobleydog2", position , true, nil, nil, team)
		         unit:SetForwardVector(caster.fw)
	         end)
