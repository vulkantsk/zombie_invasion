...
LinkLuaModifier( "modifier_razor_eye_of_the_storm_lua", "heroes/hero_silencer/eye_of_the_storm", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_razor_eye_of_the_storm_lua_debuff", "heroes/hero_silencer/eye_of_the_storm", LUA_MODIFIER_MOTION_NONE )
...
function modifier_razor_eye_of_the_storm_lua:PlayEffects1()
	-- Get Resources
	local particle_cast = "particles/econ/items/razor/razor_arcana/razor_arcana_eye_of_the_storm_rain.vpcf"
...
function modifier_razor_eye_of_the_storm_lua_debuff:HandleCustomTransmitterData( data )
	-- on client
	self.armor = self:GetCaster():GetIntellect() * (5 / 100 ) + data.armor * self:GetStackCount()
end
