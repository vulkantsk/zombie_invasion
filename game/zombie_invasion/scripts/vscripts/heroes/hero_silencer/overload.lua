LinkLuaModifier("modifier_ability_storm_spirit_overload", "heroes/hero_silencer/overload.lua", 0)
LinkLuaModifier("modifier_ability_storm_spirit_overload_buff", "heroes/hero_silencer/overload.lua", 0)
LinkLuaModifier("modifier_ability_storm_spirit_overload_debuff", "heroes/hero_silencer/overload.lua", 0)
...
function modifier_ability_storm_spirit_overload:OnOrbFire(keys)
    if IsServer() then
