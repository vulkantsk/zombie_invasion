LinkLuaModifier( "modifier_ability_sniper_shrapnel", "heroes/hero_sniper/shrapnel/shrapnel" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_sniper_shrapnel_slow", "heroes/hero_sniper/shrapnel/shrapnel" ,LUA_MODIFIER_MOTION_NONE )
...
function modifier_ability_sniper_shrapnel_slow:OnCreated()
    ...
    self.shrapnel_damage = self:GetAbility():GetSpecialValueFor("shrapnel_damage") + self:GetCaster():GetAttackDamage()
