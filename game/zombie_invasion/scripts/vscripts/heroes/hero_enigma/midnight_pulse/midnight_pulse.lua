...
LinkLuaModifier( "modifier_ability_midnight_pulse_thinker", "heroes/hero_enigma/midnight_pulse/midnight_pulse", LUA_MODIFIER_MOTION_NONE )
...
function modifier_ability_midnight_pulse_thinker:OnIntervalThink()
	...
	for _,enemy in pairs(enemies) do
		...
		self.damageTable.damage = ( enemy:GetMaxHealth()*self.damage/100 ) + self:GetAbility():GetSpecialValueFor( "damage_base" ) 
