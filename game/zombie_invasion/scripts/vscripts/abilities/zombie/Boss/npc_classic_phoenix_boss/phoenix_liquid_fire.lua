LinkLuaModifier( "modifier_ability_liquid_fire_orb", "abilities/zombie/Boss/phoenix_reincarnation", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_liquid_fire", "abilities/zombie/Boss/phoenix_reincarnation", LUA_MODIFIER_MOTION_NONE )
